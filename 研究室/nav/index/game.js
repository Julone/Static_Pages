...
var Game = /** @class */ (function () {
    ...
    Game.prototype.restartGame = function () {
        ...
        TweenLite.to(countdown, cameraMoveSpeed, { value: 0, onUpdate: function () { _this.Container.innerHTML = String(Math.round(countdown.value)); } });
    ...
    Game.prototype.addBlock = function () {
        ...
        this.Container.innerHTML = String(this.blocks.length - 1);
