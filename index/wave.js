        ...
        setTimeout(() => {
                    ...
                    g.translate(0, (100 * Math.sin(t++/10000)));
                            [170, 150, 120, 90, 60].forEach((r, i, a) => {
                                ...
                                g.fill();
                            }); g.globalCompositeOperation = "source-atop"; g.globalAlpha = 1; g.scale(3, 3);
                            for (var i = 0; i < 10; i++) {
                                g.lineWidth = 13;
                ...
                const bubbles = new Array(10).fill(0).map((e, i) => new Bubble());
                	// 泡泡数量
                const circle = (o, y, r) => {
                    if (o.y != undefined) {
                        circle(o.x, o.y, o.r);
                ...
                const clouds = new Array(6).fill(0).map((_, i, a) => {
