(function() {
    ...
    var page  = document.getElementsByClassName('ability')[0];
    // Show current items: image, text and number
    function showItems() {
        // Show image pieces
        ...
        for(var i = 0;i<slidesLength;i++)
        page.children[i].classList.remove('textActive');
        page.children[currentIndex].classList.add('textActive');
